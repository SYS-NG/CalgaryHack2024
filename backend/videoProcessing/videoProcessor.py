...
def process_eye_width_height_ratios(eye_width_height_ratios, timeframe):
    ...
    peaks, _ = find_peaks(eye_width_height_ratios, height=10)
...
def processVideo(video_path):
    ...
    left_gaze_fraction, right_gaze_fraction, center_gaze_fraction = process_gaze_directions(extracted_metrics["gaze_directions"])

    # return dictionary of processed metrics
    results = {
        "blinks_per_minute": blinks_per_minute,
        "left_gaze_fraction": left_gaze_fraction,
        "right_gaze_fraction": right_gaze_fraction,
        "center_gaze_fraction": center_gaze_fraction
    }
